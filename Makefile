...
EXPORT__PRO_FILE_ = /Users/orli/UNI/PAO/Progetto/Progetto.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents headers/air.h headers/atm.h headers/barrel.h headers/data.h headers/group.h headers/humidity.h headers/include.h headers/mainwindow.h headers/must.h headers/pressure.h headers/sensor.h headers/soil.h headers/temperature.h headers/time.h headers/vines.h headers/winery.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp sources/air.cpp sources/atm.cpp sources/barrel.cpp sources/data.cpp sources/group.cpp sources/humidity.cpp sources/must.cpp sources/pressure.cpp sources/sensor.cpp sources/soil.cpp sources/temperature.cpp sources/time.cpp sources/vines.cpp sources/winery.cpp view/mainwindow.cpp $(DISTDIR)/
